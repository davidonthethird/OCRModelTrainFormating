...
# Put your directory here for the project OCRModelTrainFormating (If you don't put full directories for this part, it can come up with an
# error occasionally)
directory = ''
if not directory:
...
for filename_ocr, values_ocr in ocr_checker.items():
    ...
    if filename_ocr in filename_training:
        ...
        if text_training != text_ocr or conf_ocr < 85 or conf_training < 85:
